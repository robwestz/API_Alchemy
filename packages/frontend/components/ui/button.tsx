/**
 * shadcn/ui Button — variants via cva, polymorphic via Radix Slot.
 * Sizes: default (h-9), sm (h-8), lg (h-10), icon (h-9 w-9).
 * Variants: default (primary/emerald), destructive, outline, secondary, ghost, link.
 */
  ...
  ],
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-foreground shadow-sm hover:bg-destructive/85",
        outline:
